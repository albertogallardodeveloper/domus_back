...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
    ...
    <a href="{{ route('admin.users.create') }}"
       class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-xl shadow transition">
...
<div class="bg-white/90 rounded-2xl shadow p-4 overflow-x-auto">
    <table class="min-w-full">
                ...
                <td class="px-3 py-2">
                    <div class="flex gap-2">
                        ...
                        <form action="{{ route('admin.users.destroy', $user) }}" method="POST"
                              onsubmit="return confirm('¿Eliminar usuario admin?')" class="inline">
                            @csrf @method('DELETE')
                            <button type="submit"
        ...
        @empty
            <tr>
                <td colspan="4" class="px-3 py-6 text-center text-gray-500">No hay administradores registrados.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
